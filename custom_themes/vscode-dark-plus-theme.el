...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; <<<<<<<<<<<<<<<<<<<<<<<<<<<<Frank Added Begin<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
   ;;;;; markdown, COPY from .emacs.d/core/libs/spacemacs-theme/spacemacs-common.el
   `(markdown-header-face-1 ((,class (:inherit bold :foreground ,ms-blue :height ,1.0 :background ,bg1))))
   `(markdown-header-face-2 ((,class (:inherit bold :foreground ,ms-green :height ,1.0 :background ,bg2))))
   `(markdown-header-face-3 ((,class (:weight normal :foreground ,ms-lightgreen :height ,1.0 :background ,bg3))))
   `(markdown-header-face-4 ((,class (:weight normal :foreground ,ms-orange :background ,bg4))))
